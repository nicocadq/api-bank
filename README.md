...
## Class vs `React.createClass` vs stateless
  ...
  - If you have internal state and/or refs, prefer use appropriated hooks to handle this cases instead of `class extends React.Component` or `React.createClass`. 
    ```jsx
    // bad
    ...
    // if is not a way with hooks (ex. Error boundaries)
...
## Declaration
  ...
  - If you are going a class component do not use `displayName` for naming components. Instead, name the component by reference.
...
## Refs
  ...
  - If you are using class components, always use ref callbacks. eslint: [`react/no-string-refs`](https://github.com/yannickcr/eslint-plugin-react/blob/master/docs/rules/no-string-refs.md)
